...
from pytracking.tracker.ac_slt_transt import ACSLTTransT
...
class SLTTransTAC(BaseActor):
    """Actor for sequence-level-training the TransT network."""
    def __init__(self, net, critic, objective, loss_weight=None, params=None):
    ...
    def explore(self, data):
        ...
        critic_iou_tensor = torch.tensor(critic_iou_list, dtype=torch.float)
        
        results['baseline_iou'] = critic_iou_tensor[:, num_seq:]
